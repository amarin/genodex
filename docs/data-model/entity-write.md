...
- Единая точка входа/навигация по всем 21 типу в UI (сейчас каждая
  группа сущностей получает свою вкладку/раздел, как «Административное
  деление» — общее меню разделов по мере роста числа вкладок может
  понадобиться пересмотреть, не сейчас).
